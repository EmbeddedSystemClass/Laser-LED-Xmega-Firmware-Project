...
#define PICID_WORKOnReady		0x0005
#define PICID_WORKSTART			0x0006
#define PICID_WORKOnStart		0x0007
#define PICID_WORKSTARTED		0x0008
#define PICID_PHOTOTYPESELECT	0x0009
#define PICID_PHOTOTYPE1		0x000b
#define PICID_PHOTOTYPE2		0x000c
#define PICID_PHOTOTYPE3		0x000d
#define PICID_PHOTOTYPE4		0x000e
#define PICID_PHOTOTYPE5		0x000f
#define PICID_PHOTOTYPE6		0x0010
